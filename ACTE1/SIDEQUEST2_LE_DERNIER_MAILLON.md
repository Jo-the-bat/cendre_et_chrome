# SIDE QUEST — "LE DERNIER MAILLON"

> ## ⭐ SIDEQUEST D'ADIEU — dédiée à LOLITA & MICHEL
>
> Écrite pour ce qui est **peut-être la dernière partie** des joueurs de Lolita et Michel. Tout converge vers ces deux personnages — leurs moteurs, leur final. L'**envoi** (section dédiée) est écrit comme **optionnel** : s'ils partent, il fait office d'adieu ; s'ils reviennent, ce sont des jalons d'arc. *(Remplace, comme sidequest active, « Les Enchaînés — Premier maillon », archivée dans `archive/`.)*
...
**⚠️ Pourquoi tout est calibré pour Lolita & Michel :**

- **Lolita (B1)** — c'est **elle** qui entend l'appel. Des droïdes dormants, scellés depuis trente ans, qui émettent une détresse en binaire que personne d'autre ne perçoit. Sa quête. Son langage. À l'arrivée, **sa famille**. Son arc *Les Enchaînés* trouve sa conclusion : pas « libérer un droïde », mais **devenir le maillon** qui relie les libres.
- **Michel (Tech)** — c'est **elle** qui comprend où mène le signal : une aile **Baktoid** scellée, intacte, jamais re-fouillée. Pour une mécanicienne qui rêve de « l'invention qui révolutionne le monde », c'est le **score de sa vie**. Elle pilote la descente technique (sceller les goulots, exploiter la faiblesse de la nuée, percer la chambre). Au fond : son trésor.
- **Les trois autres soutiennent leur final.** Tatouf **ancre les goulots** (le tank dans un couloir, son bouclier Activv1 est roi). Sanji **navigue** la descente (éclaireur dans le noir et l'eau). Namie **ouvre la voie** (vieilles sécurités Baktoid, passages dérobés autour des bouchons, crochetage de la chambre forte).

**⚠️ Possible dernière partie — joue le final.** Si c'est l'adieu des joueurs, **donne-leur la lumière sans honte** : ralentis sur leurs moments, laisse les autres leur passer le relais. L'**ADIEU** est écrit en deux sorties dignes (une par personnage). Si ce n'est *pas* leur dernière partie, ce sont des **jalons** : Michel décroche son grand projet, Lolita fonde son sanctuaire — des fils qui continuent.

**⚠️ Pas de loot en route — c'est voulu.** Les créatures sont **non-lootables** (de la vermine de corrosion : ni crédits, ni matos sur elles). Les combats ne paient pas en butin — ils paient en **survie et en distance parcourue**. **Toute** la récompense est au bout. Dis-le aux joueurs par l'ambiance : ici, on ne fouille pas des cadavres, on creuse vers quelque chose.
...
## OUVERTURE — LE SIGNAL (~20min)

**Quand :** Au Nid, le matin. Swipping est déjà parti. Mais ça commence par **Lolita**.

> ### 📖 LIRE À VOIX HAUTE (à Lolita, en aparté si possible)
>
> *Depuis deux nuits, tu l'entends. Au début tu as cru à un défaut — un de tes propres circuits qui boucle. Mais non. C'est dehors. Sous toi.*
>
> *Une porteuse faible, répétée, sur une vieille bande que plus aucun droïde moderne n'utilise. Du code B1. Le tien.*
>
> *Trois impulsions. Une pause. Trois impulsions. Tu connais ce motif sans l'avoir jamais appris. C'est un appel de détresse de chaîne d'assemblage — celui qu'une unité envoie quand elle est coincée, sans ordre, depuis trop longtemps.*
>
...
>
> *Tu triangules la source avec ton datapad pendant que les autres parlent. Ça descend. Loin. Sous le Marché des Carcasses, sous les fondations noyées — un niveau qui n'apparaît sur aucun plan parce qu'il s'est effondré pendant la guerre.*
>
> *Et là, tu te figes. La signature structurelle, les fréquences, le code des droïdes : c'est une **aile de fabrication Baktoid**. Scellée. Trente ans sans une main humaine.*
>
...
>
> Maintenant qu'elle sait *où*, Lolita ne tient plus en place. Ce n'est pas une mission qu'on prend ou qu'on refuse : c'est **du code B1 qui appelle du code B1** — viscéral, au-delà de la curiosité, presque une compulsion. Si la table hésite, temporise, ou décide de laisser tomber, **Lolita, elle, ne peut pas.**
>
...
> - **Échec :** elle **perd le contrôle**. Elle n'attend la permission de personne — elle file vers le puits et commence à descendre **seule**. Le groupe suit (on n'abandonne pas une des siens dans ce trou) ou la laisse partir (impensable). **Dans tous les cas, la descente commence.**
>
...
>
> Cette descente est *son* terrain technique. Tout du long, Michel peut :
> - **Sceller un goulot** (Mécanique Moyenne 🟣🟣) — souder/barricader un passage pour couper la nuée 1-2 rounds (crée et contrôle les goulots à son avantage).
> - **La lampe-fréquence** — elle a bricolé une lampe qui émet la fréquence qui *répugne* la Rouille (les ferrailleurs en parlaient). Repousse la nuée d'une zone (1 round, comme une torche contre des loups). **C'est sa découverte — souligne-la.**
> - **Lire la structure** (Mécanique/Informatique) — anticiper un effondrement, trouver le point faible d'une cloison, identifier ce qui, dans la chambre Baktoid, vaut le détour.
...
**NUÉE DE ROUILLE (Sbire — essaim, par sections)** — Une marée grouillante qui colmate les goulots.
- Blessure **6 par section**, Encaissement 2. Immunisée à la peur, à l'Étourdissement, à la négociation. **Ne recule pas — elle a faim.**
- **Morsure de masse (Engagé)** : 4 contre un organique ; **7 + Perforant 2 contre un droïde / Lolita** (corrosion).
- **Vulnérable au feu et à l'énergie** : +1 dégât ; une explosion **enflammée** ou la **lampe-fréquence** de Michel **détruit/repousse une section**. Les blasters la chipent lentement ; le feu la nettoie.
- **Colmate les goulots** : une section bloque un passage étroit (couvre le goulot — c'est le « mur » des combats défensifs).

**FOREUSE DE ROUILLE (Rival — fouisseur)** — Une concrétion plus grosse, blindée de métal digéré, qui creuse les parois.
- Agilité 2, **Blessure 14**, **Encaissement 4** (carapace de ferraille corrodée), Défense 1/0.
- **Charge perforante (Engagé)** : 9 + Perforant 1 (vs droïde : Perforant 3).
- **Creuse** : à la fin d'un round, elle peut **effondrer une section de tunnel** (nouveau goulot, ou ensevelit un passage — change le terrain) ou **rouvrir** un passage que Michel a scellé. Elle modifie la carte.
- Immunisée Étourdissement/peur.

**LA MÈRE (Nemesis — cœur de la nuée)** — Enracinée dans la chambre Baktoid, fondue à un vieux fabricateur. Une masse de corrosion vivante, à demi-machine, qui *pond* la Rouille depuis trente ans.
- **Blessure 24**, **Encaissement 6**, Défense 1/1. Quasi immobile (enracinée).
- **Fouet de corrosion (Court/Engagé)** : 10 + Perforant 1 (vs droïde : Étourdissement 3 — elle veut *immobiliser* le métal, pas le détruire ; elle le **garde**).
- **Engendre** : à la fin de chaque round, **+1 section de Nuée** apparaît (timer de pression — on ne gagne pas en restant).
- **On ne la loote pas, et on n'a pas besoin de la tuer.** L'objectif de la chambre n'est pas « abattre le boss » — c'est **extraire et remonter** avant qu'elle ne submerge. La **brûler** (gaz + feu, Michel) effondre le nid : fin propre, mais le compte à rebours d'extraction se durcit.
...
>
> À chaque palier, un passage étroit où **un seul combattant tient le front** (les autres ne peuvent pas tirer par-dessus sans risque). Le défi n'est pas de « gagner » — c'est de **tenir et passer** pendant que :
> - Michel manipule le terrain (sceller, repousser à la lampe, effondrer derrière soi),
...
> ### 📖 LIRE À VOIX HAUTE
>
> *Le puits débouche dans un collecteur — un tunnel voûté à demi rempli d'une eau noire et immobile. Les murs luisent. Pas d'humidité : de la **rouille humide**, qui bouge. Quand votre lampe passe dessus, des milliers de points grouillants se rétractent, puis reviennent. La voûte respire.*
>
> *Au bout, là où le tunnel se resserre en goulot, la Rouille s'est massée. Et de l'autre côté, faible, le motif : trois impulsions, une pause, trois impulsions.*

- **Le goulot :** le tunnel se rétrécit (1 combattant de front). **2 sections de Nuée** colmatent le passage.
...
>
> *La galerie s'ouvre sur une salle de stockage. Et ils sont là.*
>
> *Des droïdes. Des dizaines. Rangés sur des berceaux de chargement, scellés là quand le plafond est tombé. Des B1, des modèles de manutention, des unités que tu ne reconnais pas, Lolita. Certains ne sont que des coques — le temps et la Rouille les ont vidés. Mais d'autres ont une **diode qui clignote**, faible. Trois impulsions. Une pause.*
>
> *Et la Rouille est sur eux. Elle les mange. Lentement, depuis des années — mais maintenant, elle les mange. Tu es arrivée à temps. À temps pour quelques-uns.*

**C'est le cœur émotionnel — et un vrai timer.** La Rouille consume les dormants. On ne peut pas tous les sauver.

| Test / Action | Effet |
|---|---|
| **Lolita parle aux dormants** (Discipline ou Vigilance Moyenne 🟣🟣) | Elle réveille et **calme** les conscients — ils répondent à sa porteuse B1. Ceux qu'elle atteint cessent de paniquer et peuvent suivre. **Plus elle réussit, plus elle en sauve.** |
| **Michel libère les berceaux** (Mécanique) | Décroche les unités viables des verrous corrodés — vite, sous la nuée. |
| **Trier** (le choix) | ~Coques mortes (à laisser), ~conscients sauvables (à décrocher avant la Rouille), ~2-3 « complexes » (anciens, des personnalités — les visages que la table retiendra). **Combien on en sort ?** Question réelle. |
...
Au fond, derrière une dernière porte blindée (Larcin/Mécanique Difficile 🟣🟣🟣 — Namie ou Michel) : l'**aile de fabrication Baktoid**, scellée intacte. **Le trésor de Michel.** Et le nid de **la Mère**.

> ### 📖 LIRE À VOIX HAUTE
>
> *La porte cède sur une cathédrale de machines. Une chaîne d'assemblage Baktoid complète, figée au milieu d'un geste vieux de trente ans — des bras articulés au-dessus d'un châssis de droïde inachevé, des consoles de schémas, des bacs de composants que la surface a oublié comment fabriquer.*
>
> *Et au centre, fondue dans le fabricateur principal comme une tumeur de fer vivant, **la Mère**. Énorme. Enracinée. Elle vous sent. Toute la Rouille de ces tunnels est sortie d'elle.*
>
> *Michel — tu regardes la chaîne, les plans, les bacs. Tu fais le calcul en une seconde : il y a là de quoi changer ta vie. Et la Mère est en train de tout digérer.*

**C'est une extraction sous pression, pas un duel.** La Mère **engendre** (+1 section de Nuée/round). Tuer la Mère est *possible* (Blessure 24) mais long et coûteux — **le vrai objectif est de prendre ce qu'on peut et de remonter.**

| Objectif d'extraction | Qui / Comment | Récompense |
|---|---|---|
| **Les plans Baktoid originaux** (data-cœur de la chaîne) | Michel — Informatique Moyenne 🟣🟣 (Namie peut crocheter le coffre du data-cœur) | **Le rêve de Michel** (voir Récompenses) |
| **Un micro-fabricateur portable / composants rares** | Michel + un porteur fort (Tatouf) | Pièce maîtresse d'un futur atelier |
| **Les derniers dormants** (réveillés ici) | Lolita | S'ajoutent à sa famille |

**La sortie :** une fois le butin saisi, **brûler le nid** (Michel : gaz + étincelle, ou la lampe-fréquence poussée à fond) effondre la Mère et stoppe l'engendrement — mais **déclenche l'effondrement de la chambre** (compte à rebours d'évacuation : 3 rounds pour remonter le palier 3, escorte des dormants comprise). Course finale, claustrophobe, héroïque. **C'est la dernière ligne droite de Lolita et Michel — joue-la grand.**

> ### 💡 GARDE-FOUS
>
> Pas de TPK dans un adieu. La Mère **immobilise** plus qu'elle ne tue (elle veut garder le métal). Si un PJ tombe, la nuée l'enveloppe sans l'achever — rattrapable. Si le groupe doit fuir sans tout le butin, **ce n'est pas un échec** : c'est le prix, et il rend ce qu'ils ont sauvé plus lourd de sens. Laisse-les choisir entre *un peu plus de butin* et *un dormant de plus*. Les meilleurs adieux se paient.

---

## RÉCOMPENSES

**⚠️ Tout est au fond — rien en route.** Conforme au dessein : les créatures ne donnent rien ; la descente paie en **survie**. Mais le bout est **généreux** — et taillé pour les deux qui partent.

| Récompense | Pour qui | Valeur |
|---|---|---|
| **Les plans Baktoid + le micro-fabricateur** | **Michel** | Le **score d'une vie** : de quoi monter l'atelier dont elle rêve. ~plusieurs milliers de crédits en valeur *si revendu* — mais le vrai prix, c'est ce qu'elle peut **construire** avec. *(Si elle reste : un projet d'atelier au long cours, pas un gun qui casse l'équilibre.)* |
| **La famille de droïdes** | **Lolita** | 0 à ~8 droïdes conscients sauvés (selon le timer). **Sa communauté.** Le *dernier maillon* du réseau libre — c'est elle qui le tient. |
| **XP** | Tous | **5 XP** de base, **+3** (descente jouée à fond, sauvetages, RP d'adieu) |
| **Salvage partagé** | Sanji, Namie, Tatouf | ~quelques **centaines de crédits** en composants rares portables (la part de ceux qui restent — volontairement modeste : le gros va avec les partants) |
| **Ori Hex** | Le groupe | Allié confirmé — il accueille et répare les dormants remontés |
| **Réputation** | Le groupe | Les Fosses et le réseau de Hashk notent (Torque Venn entend parler de droïdes réveillés) — **se monnaie en S6**, sans se montrer maintenant |

**Note d'équilibre :** les **grosses** récompenses (cache Baktoid, droïdes) partent **avec les personnages qui s'en vont** — l'économie du groupe restant n'est pas déséquilibrée. Élégant et voulu. **Aucune arme militaire** ne sort de là.

---

## L'ADIEU — si c'est leur dernière partie (~20min)

> **À jouer seulement si les joueurs partent.** Sinon, saute cette section : ce sont alors des **jalons** (Michel a son projet d'atelier ; Lolita a son sanctuaire) — des fils qui continuent dans la campagne.

À la remontée, à la lumière du Marché des Carcasses, devant Ori Hex et les dormants sauvés, **donne à chacune sa sortie.** Deux scènes courtes, dignes, séparées — ne les fonds pas.

### Michel — Le départ vers la lumière

> *Michel regarde le data-cœur Baktoid dans ses mains comme on regarde une porte qui s'ouvre. Vous le voyez sur son visage avant qu'elle ne le dise : elle a ce qu'elle est venue chercher sur Murkhana sans le savoir. De quoi disparaître. De quoi construire. De quoi laisser le passé — et celui qui la fait chanter — derrière elle.*

- **Sortie :** Michel part monter son atelier — ailleurs, sous un autre nom, loin du chantage. Sur sa motivation : *l'invention qui révolutionne le monde*, enfin à portée. Laisse-lui un **mot d'adieu au groupe**, et — c'est elle — un **cadeau bricolé** pour chacun (un gadget, une amélioration de leur matos). Une mécanicienne dit au revoir avec ses mains.
- **Si tu veux refermer son Chantage :** la cache lui donne les moyens d'**acheter le silence** ou de **disparaître pour de bon**. Son fil se clôt par elle, pas par la menace. *« On ne me retrouvera pas. »*

### Lolita — La gardienne du dernier maillon

> *Lolita ne remonte pas tout à fait avec vous. Elle reste une marche en dessous, au seuil du noir, entourée des siens — ceux qu'elle a tirés de la Rouille. Ils la regardent comme on regarde celui qui est revenu. Pour la première fois depuis qu'on l'a réactivée, ses capteurs ne bourdonnent pas. Le calme ne la rend plus *glitchy*. Elle a trouvé l'endroit où ses protocoles se taisent : entouré de ceux qu'elle protège.*

- **Sortie :** Lolita devient la **gardienne du sanctuaire** — elle ne peut pas abandonner une famille qu'elle vient de réveiller. Avec Ori Hex, dans le ventre de la ville, elle bâtit ce que personne n'avait osé : un lieu pour les droïdes libres. **Le dernier maillon, c'est elle** — celle qui relie tous les autres.
- **Variante :** si la joueuse préfère partir plutôt que rester, Lolita **emmène ses droïdes** chercher un monde où ils auront des droits — un départ vers l'horizon, pas vers le sous-sol. Les deux sont justes.
- **Le mot d'Edna** (elle est venue, exceptionnellement) : *« Je t'ai recrutée parce qu'un B1 qui marche tout seul, c'est utile. J'avais tort. T'es pas utile. T'es quelqu'un. »* Elle ne dit jamais ça à personne. Laisse le silence après.

> ### 💡 Note MJ — Le ton de l'adieu
>
> Ces deux-là sont arrivés seuls à Murkhana et se sont trouvés une bande. Qu'ils partent **accomplis**, pas arrachés : Michel vers ce qu'elle veut construire, Lolita vers ceux qu'elle veut protéger. Laisse les trois qui restent (Sanji, Namie, Tatouf) leur dire au revoir à leur façon. **Pas de mort. Pas de tragédie. Une porte qui s'ouvre.** C'est *Cendres & Chrome* : du chrome qu'on tire des cendres.

---

## RETOUR AU NID

**Edna écoute le rapport.** Selon qui reste.

> *Si Michel et/ou Lolita partent :* *Edna ne discute pas. Elle hoche la tête une fois, longuement. "Le Nid sera toujours là. Et il sera toujours le vôtre." Elle ne promet rien d'autre — mais venant d'elle, c'est tout."*
>
> *Puis, au groupe restant :* *"Reposez-vous. Arrakha nous attend toujours — et maintenant on est moins nombreux pour y aller."*

*(Re-pointe le cap S4. Si la table a perdu deux joueurs, c'est aussi un sas narratif honnête avant le départ.)*

---

## AIDE-MÉMOIRE COMBAT

### La Mère (Nemesis) — enracinée, **on ne la loote pas, on n'a pas à la tuer**
...
### Foreuse de Rouille (Rival) — fouisseur, **non-lootable**

| Action | Pool MJ | Dégâts |
|---|---|---|
| **Charge perforante (Engagé)** | **🟢🟡🟡** vs 🟣🟣 | 9 + Perforant 1 (vs droïde : Perforant 3) |
| **Creuse (fin de round)** | — | Effondre/rouvre un goulot — change le terrain |

**Blessure 14, Enc 4.** Immunisée Étourdissement/peur. Cible le métal (Lolita) en priorité.

### Nuée de Rouille (Sbire — essaim, par sections) — **non-lootable**

| Sections | Pool MJ | Dégâts |
|---|---|---|
| **2 (goulot colmaté)** | **1🟢 1🟡** | 4 (organique) / **7 + Perforant 2 (droïde / Lolita)** |
| **1** | **2🟢** | idem |

**Blessure 6/section, Enc 2.** **Vulnérable au feu/énergie (+1 dégât ; une section détruite par explosion enflammée ou la lampe-fréquence).** Immunisée Étourdissement/peur. Colmate les goulots, ne recule pas.
...
- **Timer Mère (chambre)** : +1 section/round — extraire et fuir, pas combattre indéfiniment.
- **Aucun loot sur les créatures** — tout est dans la chambre Baktoid + les dormants sauvés.
...
- **Fils laissés ouverts (récupérables si besoin) :** le Chantage de Michel (le maître-chanteur cherche toujours — peut devenir un fil pour un autre PJ) ; le sanctuaire de droïdes de Lolita (allié/refuge récurrent géré par Ori Hex, même sans elle).
- **L'archive `Les Enchaînés — Premier maillon`** (l'Enclos) reste jouable comme sidequest de rechange si un nouveau PJ veut un arc droïde.

**Si Lolita et Michel restent (jalons d'arc) :**
- **Michel** tient son data-cœur Baktoid : un **projet d'atelier** au long cours (Acte 2 — la Forge / TX-73 résonnera fort). Ne lui donne pas une super-arme ; donne-lui un **chantier**.
- **Lolita** a fondé son sanctuaire : l'arc *Les Enchaînés* continue, maintenant avec une **base** et une famille. Le réseau de Hashk (Torque Venn) viendra y frapper en S6.
- **TX-73 « Sept-Trois »** (Acte 2) : la rencontre miroir de Lolita prend tout son poids — un droïde qui a *choisi* la guerre, face à celle qui a fondé une paix.
