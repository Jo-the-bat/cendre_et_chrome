...
**Durée estimée :** ~4h  
**Joueurs :** 6  
**Contenu :** Briefing Hashk (~15min) + enquête libre 2-3 pistes (~2h) + scène du Convoi (~15min) + premier avertissement (~30min) + clôture (~15min)  
**Mécaniques introduites :** Enquête ouverte (les joueurs choisissent l'ordre), Informatique/Piratage, Connaissance (Pègre), Tromperie/Charme en contexte d'investigation  
**Résumé :** Les joueurs reçoivent le contrat Hashk Ellor — 50 000 crédits, vivant uniquement, commanditaire anonyme. Ils enquêtent à travers Murkhana City et rencontrent deux PNJ récurrents majeurs (Nox Erso, Fenn Sudo). La scène du Convoi est le premier gut-punch émotionnel de la campagne. Le réseau de Hashk commence à les observer.
...
- Prépare les noms des PNJ de cette session : **Nox Erso**, **Fenn Sudo**, **Rezz** (s'il est encore amical)

---

## OUVERTURE — LE CONTRAT (~15min)
...
>
> *Basch intervient : "Les Serres sont aussi sur le contrat. Kreel Voss et son équipe. Si vous les croisez, ne leur donnez rien."*
>
> *Edna hoche la tête.*
>
> *"50 000 crédits, c'est trop d'argent pour un seul homme. Quand c'est trop beau..." Elle caresse sa cicatrice. "Soyez prudents. Et commencez par le bas — les gens des Fosses savent toujours plus qu'ils ne disent."*

### Questions des joueurs

| Question | Réponse d'Edna/Basch |
|---|---|
| *"C'est qui le client ?"* | Edna : *"Anonyme. Le contrat est passé par trois intermédiaires. Ça sent le gros poisson — quelqu'un qui ne veut pas être associé à ça."* |
| *"Pourquoi vivant uniquement ?"* | Basch : *"Le client veut lui parler. Ou l'interroger. Ça arrive quand la cible sait quelque chose."* |
| *"50 000 pour un comptable ?"* | Edna : *"Exactement. Un comptable. Alors pourquoi quelqu'un paye une fortune pour un type qui faisait des additions ? C'est ça la question."* |
...
### PISTE 1 — LA TOUR ARGENTE (niveaux intermédiaires)

**Ce que les joueurs cherchent :** Le bureau de Hashk sous l'alias "Directeur Kole".

**Comment y arriver :** Les joueurs montent dans la Tour Argente — l'ancien QG de l'Alliance Corporative. Les niveaux intermédiaires (10-30) sont un labyrinthe de couloirs, de bureaux reconvertis, et de marchés informels.
...
|---|---|
| **Succès** | Un commerçant du niveau 18 : *"Directeur Kole ? Bureau au 22. Il paye bien, il parle pas. Tout le monde le connaît, personne sait ce qu'il fait."* |
| **Succès + Avantages** | + *"Il a pas été vu depuis deux semaines. Mais ses gens passent encore."* |
...
**C'est au Port Gris que les joueurs rencontrent Nox Erso** (voir section dédiée ci-dessous).

---

### PISTE 3 — LES FOSSES (Fenn Sudo)

**Ce que les joueurs cherchent :** Des informations dans les bas-fonds.
...
**⚠️ Note MJ :** C'est le **gut-punch émotionnel** de l'Acte 1. Ne pas couper, ne pas accélérer. Lire lentement. Laisser le silence après.
...
>
> *Une femme s'accroche à un homme plus âgé — trop vieux pour les mines. Il lui murmure quelque chose. Elle secoue la tête. Les gardes les séparent sans brutalité — juste avec l'efficacité morne de la routine.*
>
...
>
> *"Programme d'emploi. Arrakha. Tu parles."*
>
...
**Si un joueur veut intervenir :** Laisser faire. Les gardes en gris ne sont pas des combattants (sbires, Blessure 5 chacun, pistolets), mais intervenir attire l'attention du syndicat ET de Vektor. Le MJ ne doit pas empêcher — mais les conséquences sont réelles.
...
**Quand :** En fin de session, quand les joueurs quittent un lieu ou traversent Murkhana City. La scène arrive **après** au moins 2 pistes d'enquête — les joueurs ont posé assez de questions pour être repérés.

> ### 📖 LIRE À VOIX HAUTE
>
> *Vous traversez un couloir des niveaux intermédiaires quand deux silhouettes se détachent d'une alcôve. Des Koorivar — grands, des cornes en spirale, armés mais pas menaçants. Ils ne bloquent pas le passage. Ils attendent.*
>
> *Le premier parle d'une voix calme :*
>
> *"Le Directeur Kole sait que vous posez des questions. Ça ne lui pose pas de problème — beaucoup de gens posent des questions. Mais il veut que vous sachiez une chose : vous ne trouverez pas ce que vous cherchez en fouillant des bureaux vides."*
>
> *Le second ajoute :*
>
...
### Si les joueurs réagissent

**Agressivité / menace :** Les Koorivar ne se battent pas. *"On n'est pas là pour ça."* Ils partent. Mais le rapport envoyé à Hashk sera : "violents, imprévisibles."
...
**Intimidation (Moyenne 🟣🟣) :** Succès → un Koorivar lâche un détail supplémentaire : *"Le Directeur aide les gens que personne n'aide. Demandez dans les Fosses — tout le monde vous le dira."* Échec → ils partent sans rien ajouter.
...
**Les Koorivar (sbires, groupe de 2) :**

| Stat | Valeur |
|---|---|
| Blessure | 6 chacun |
| Encaissement | 3 |
| Combat distance | 2🟢 (groupe) |
| Équipement | Pistolets blaster (6), couteaux vibro (4) |

> 💡 Les Koorivar ne veulent PAS se battre. Si les joueurs attaquent, ils se défendent et fuient à la première occasion — via les couloirs qu'ils connaissent mieux que les joueurs.

**Note MJ :** Les Koorivar rapportent à Hashk comment les joueurs ont réagi. C'est le premier rapport du réseau sur eux. Hashk ne prend aucune décision basée sur ça — il accumule les données, comme un comptable.
...
>
> *"J'espère que c'est la deuxième option."*
...
| Récompense | Valeur |
|---|---|
| **Crédits** | Pas de prime — c'est une enquête en cours |
| **XP** | 15 XP |
...
|---|---|---|
| Fouille bureau | Charme locaux, Corruption dockers, Informatique Tour, Intimidation Koorivar | Informatique Port Gris, Perception (suspicion Fenn) |
...
- **Le Convoi** est la scène centrale — tout le reste est secondaire
...
- **La Tour Argente** est un lieu nouveau — décrire la verticalité, l'odeur de soudure, les niveaux

### Ce que les joueurs devraient savoir en fin de session

- Hashk/Kole voyage vers Arrakha régulièrement
- Il aide les gens des niveaux bas (rachète des dettes, cliniques)
