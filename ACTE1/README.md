...
**Sessions :** 0 à 9 (1 soirée création + 9 sessions de jeu)  
**Durée par session :** ~4h  
**Ton :** Aventure, découverte, humour — montée progressive vers la tension  
**Objectif narratif :** Les joueurs découvrent le secteur Auril à travers ses trois mondes (Murkhana, Arrakha, Forscan Prime), s'attachent au Consortium et à la culture murkhanaise, et réalisent progressivement que leur cible — Hashk Ellor — est plus complexe qu'une simple prime.
...
| Mission | Lieu | Ce que ça apporte |
|---|---|---|
| **Escorte de convoi** | Route Murkhana → Arrakha | Les joueurs voient le trajet des conscrits de l'intérieur |
| **Récupération de cargaison** | Cron Drift | Champ d'astéroïdes, navigation dangereuse, pilotage |
...
Première scène de jeu de la campagne. Le MJ lit ou paraphrase :

> *Le Nid d'Edna n'a rien de glamour. C'est un ancien hangar industriel au niveau 14 de Murkhana City, reconverti en quartier général du Consortium. L'air sent le métal rouillé et le ragoût d'Edna. Des hamacs longent les murs. Un tableau holographique affiche les primes en cours. Au-dessus de la porte d'entrée, une Pierre Noire — un fragment de récif corallien noirci par les pluies acides.*

Scènes de RP libre :
- **Edna** accueille les joueurs. Ragoût, surnoms, chaleur. *"Tu as faim ? Mange d'abord, on parle après."*
- **Basch** fait le briefing : 70/30, on ramène ses coéquipiers vivants, on ne pose pas de questions sur les clients.
- **Ambiance :** Un chasseur murkhanais nettoie sa Pierre Noire. Dehors, un chant lointain — le Chant des Marées. *"C'est un truc de vieux. Ils le chantent pour les morts."*

**Note MJ :** Edna doit être aimée. Basch doit être respecté. La Pierre Noire et le Chant sont du décor — pas d'explication, juste de la présence.

### Phase 2 — Le contrat Vekk Draal (~3h)

Basch affiche le dossier : Vekk Draal, Nikto, chef du gang "Les Griffes Rouges", 5 000 crédits.

4 rencontres tutoriel :
1. **Cantina des Fosses** (~30min) — Enquête sociale. Trouver un informateur. Mécanique : tests de Charme/Coercition.
2. **Fusillade dans les ruelles** (~45min) — Premier combat au blaster. Mécanique : combat structuré, couverture.
3. **Poursuite au Port Gris** (~30min) — Draal s'enfuit vers son cargo. Mécanique : Athlétisme, Pilotage (speeders).
4. **Combat spatial** (~45min) — Le Crochet Rouillé décolle. Les joueurs le poursuivent. Mécanique : combat spatial simplifié.
...
Un contact mentionne en passant : *"Un type du Bureau de Sécurité pose des questions. Un certain Vektor."*
...
## SESSION 4 — "LE MONDE DE POUSSIÈRE"

**Durée estimée :** ~4h  
**Contenu :** Voyage (~30min) + exploration Torren/Puits Rouges (~1h30) + mission sauvetage (~2h)
...
### Découvrir le système (~1h30)

Via **Jyn Tracert** (contact du Consortium à Torren) et les mineurs :
- Quotas individuels et collectifs, endettement, Gorges de Lucas comme punition
...
Jyn propose — pas comme un test de Hashk, mais parce que c'est la réalité des mines :
> *"Il y a un mineur effondré dans les niveaux inférieurs des Puits. La direction ne va pas envoyer de secours — il ne vaut pas le coût."*

Mission : descente dans les niveaux inférieurs. Chaleur, poussière, danger d'effondrement. Les joueurs voient le système de l'intérieur. Possibilité de rencontrer un **Rampant des Sables** dans les galeries basses.

**Note MJ :** Jyn rapportera à ses contacts (dont certains sont liés à Hashk) comment les joueurs se sont comportés. Si les joueurs ont sauvé le mineur, le réseau en prend note. Mais personne n'a organisé cette situation — des mineurs s'effondrent dans les galeries tous les jours.

### Indice Hopner

Ordre intercepté ou mentionné par un stormtrooper : *"L'Amiral a ordonné zéro mort civile. Incapacitantes uniquement."*
...
## SESSION 5 — "LE POING DE VELOURS"

**Durée estimée :** ~4h  
**Contenu :** Voyage + visite Kelden (~1h30) + mission concrète (~2h) + campagnes optionnel (~30min)

### Comment les joueurs arrivent — La piste

Ce n'est PAS un détour arbitraire. Pendant l'enquête sur Arrakha (session 4), les joueurs trouvent un **indice qui pointe vers Forscan** :
- Un registre de vol saisi dans les archives de Torren montre que les ordres de conscription portent le sceau de **Forge-7, Forscan Prime**.
- Ou Jyn Tracert mentionne qu'un contact du réseau de Hashk a **disparu** après s'être rendu à Kelden — il cherchait des informations sur Forge-7.
- Ou Edna leur confie un contrat de **protection d'un marchand** qui livre à Kelden — prétexte parfait.

### Kelden — La vitrine (~1h)

> *Kelden est propre. Les rues sont pavées. Les enfants vont à l'école. Les stormtroopers patrouillent avec courtoisie — "Bonjour, citoyen." L'un d'eux est un Koorivar. Un autre, un Gran. Ils portent la même armure blanche que les humains. Après Murkhana et Arrakha, c'est déstabilisant — ce n'est pas l'Empire tel que les joueurs l'imaginent.*
...
**Option A — Le contact disparu :** Les joueurs enquêtent sur le contact de Hashk qui a disparu à Kelden. Piste : il a été arrêté par la FSK après avoir posé des questions sur Forge-7. Les joueurs doivent le retrouver — dans une cellule de la FSK, ou dans un convoi de transfert vers la base. Mission d'infiltration/sauvetage qui montre la vraie nature de la FSK.

**Option B — Protection du marchand :** Le marchand d'Edna est menacé par des agents de la FSK qui veulent une "contribution". Les joueurs doivent négocier, payer, ou confronter la FSK. Mène à une poursuite en speeder dans les rues de Kelden si ça dégénère.

### Les Fermes Grises (optionnel, ~30min)

Si les joueurs sortent de Kelden : villages silencieux, méfiance, résistance passive. *"Kelden, c'est la vitrine. Nous, on est le prix à payer."* Contact possible avec **Meema Kern** (Réseau Racine).

### Vektor (optionnel)

Un homme en civil observe les joueurs dans une cantina. Sourire poli. Part. Ils ne savent pas qui c'est.
...
Après Forscan, les joueurs ont vu les trois mondes. Ils comprennent le système.

**Le réseau se montre :** Ce qu'ils avaient manqué avant est maintenant visible — Pierres Noires de ralliement sur les comptoirs, distributions de nourriture financées par un "bienfaiteur anonyme", cliniques clandestines, murmures dans les mines : *"Le Chant arrive."*

**Nox réapparaît :** Elle a des informations sur les mouvements impériaux. Toujours serviable. Pourquoi ?
...
> *Un Muun grand, mince, vêtu de robes simples. Devant lui : une Pierre Noire plus grande que les autres.*
>
> *"Vous me cherchez depuis des semaines. Vous savez qui m'a mis une prime. Et maintenant, vous savez pourquoi. Murkhana d'abord — on reprend notre ville. Arrakha ensuite — on libère nos gens. Le Chant des Marées sera le signal."*

**Ce qu'il révèle :** Plan dual, cellules populaires, droïdes B1, soutien NUS. Grandes lignes.  
**Ce qu'il cache :** Plan B, la Forge, le rôle réel de la NUS, les armes républicaines.
...
**Durée estimée :** ~4h  
**Contenu :** Session sociale et de respiration. Visite du Moria de Gekko. Sabacc, ambiance, premier vrai contact avec le Hutt. Changement de ton bienvenu après la tension de la session 6.

### Comment les joueurs arrivent

Plusieurs raisons possibles :
- **Contrat d'Edna :** Capturer un contrebandier qui se cache au Moria.
- **Invitation de Fenn Sudo :** *"Gekko organise un tournoi de sabacc. 10 000 crédits de mise. Il a entendu parler de vous. Il veut que vous veniez."*
- **Initiative des joueurs :** Après la rencontre avec Hashk, les joueurs cherchent des informations ou du matériel que seul Gekko peut fournir.

### Le Moria — Ambiance

> *Le Moria est tout ce que Murkhana n'est pas : propre, luxueux, décadent. Le Hall Principal est une immense salle circulaire avec un plafond vitré donnant sur les étoiles. Tables de sabacc, roulettes, musique live. Des serveurs droïdes circulent avec des plateaux. L'air sent le parfum et les crédits.*

**Ce que les joueurs peuvent faire :**
- **Jouer au sabacc** — Mécanique : tests de Tromperie/Sang-froid, avec des crédits en jeu. Un joueur peut gagner gros — ou perdre gros.
- **Explorer l'Arène** — Combats de gladiateurs. Un joueur peut participer (récompense + réputation) ou parier.
- **Visiter le Marché Noir VIP** — Armes, pièces de droïdes, informations. Tout a un prix.
- **Rencontrer Gekko** — S'ils sont invités (par Fenn Sudo ou Grep).

### Majordome Grep

Grep accueille les joueurs : *"Chers amis, bienvenue au Moria. Une seule règle : pas de violence dans la station. En dehors de ça, tout est permis."*

Il les installe, leur explique les attractions, et les surveille discrètement.

### Premier contact avec Gekko (optionnel)

Si Gekko reçoit les joueurs (pas obligatoire en Session 7 — il peut attendre l'Acte 2) :

> *Un Hutt massif, jovial, rieur. Il mange en parlant. Il rit en menaçant. Chaque mot est pesé derrière la vulgarité.*
>
...
Les joueurs croisent un Devaronian charmeur qui les observe depuis une table de sabacc. Sourire. Contact visuel. Il ne dit rien. C'est **Sly Nmap** — le tueur à gages de Gekko. Les joueurs ne le savent pas encore.
...
De retour sur Murkhana après le Moria, les joueurs sentent l'étau :

- **Vektor se manifeste :** Un contact des joueurs refuse de parler. Un informateur a été arrêté. Un rapport du BSS mentionne le Consortium. Le Superviseur cartographie les joueurs sans se montrer.
...
Un détail arrive avec la révélation :
> *"L'Amiral n'est pas comme les autres. Après Endor, quand Palpatine a ordonné l'Opération Cendre — brûler ses propres mondes — elle a refusé. Elle a protégé son secteur."*

Ce n'est pas un monstre. C'est un adversaire avec des principes.

### Edna réagit

> *"Le Consortium survivra. On a survécu à l'Empire, on survivra à Hopner. La question, c'est vous — qu'est-ce que vous voulez faire ?"*

Elle ne force pas. Elle écoute. Elle suit.

**XP :** 15 XP

---

## SESSION 9 — "LE POINT DE NON-RETOUR"

**Durée estimée :** ~4h  
**Contenu :** Événement déclencheur (~30min) + choix des joueurs (~30min) + climax action (~3h)

### L'événement déclencheur

Le Verdict Gris déploie des navettes vers Arrakha. Raid limité — opération ciblée pour capturer Hashk dans les canyons. Pas un assaut total (c'est l'Acte 2 qui verra le vrai soulèvement).

Sur Murkhana, la nouvelle se répand. Les cellules de Hashk s'agitent — mais le soulèvement n'est pas lancé. C'est trop tôt.

### Le choix des joueurs

5 options :
1. **Aider l'Amiral (Arrakha)** — Rejoindre le raid
2. **Aider Hashk (Arrakha)** — Prévenir/évacuer le Terrier
3. **Aider Hashk (Murkhana)** — Aider les cellules à profiter du chaos
4. **Rester neutres** — Profiter de la confusion
5. **Avertir la République** — Graine pour l'Acte 2

### Le Chant commence

Quel que soit le choix, le Chant des Marées frémit — dans les Fosses ou dans les galeries. Pas encore le signal. Mais le peuple sent que quelque chose arrive.

### Climax (~3h)

**Sur Arrakha (si les joueurs y vont) :**
- Course contre la montre pour atteindre le Terrier avant les Impériaux
...
- Confrontation avec un syndicat qui profite du chaos pour attaquer le Nid d'Edna
- Combat urbain : gardes de syndicat + B1 Sentinelles Chromés

### Conclusion

> *La poussière retombe. Le Chant des Marées murmure encore — dans les Fosses, dans les galeries, dans les canyons. Pas encore un cri. Un avertissement.*
>
...
**Rampant des Sables** — Serpent blindé 3-4m, silhouette 2. Blessure 8, Bagarre 2, Morsure dégâts 6 (Enchevêtrement). Embuscade souterraine.
...
#### Les Rouillés (droïdes de Hashk)

**B1 Réactivé** — *Sbire (groupes de 4-6)*
- Silhouette 1 | Blessure : 3 | Blindage : 2
- Combat à distance (armes légères) | Blaster E-5 (dégâts 9, portée moyenne)
- **Dysfonctionnement :** Chaque Menace → glitch (parle en boucle, vise le mauvais camp, se désactive).

**B2 Super Battle Droid** — *Rival*
- Silhouette 1 | Blessure : 10 | Blindage : 4
- Combat à distance (armes légères) 2 | Double blaster de poignet (dégâts 8, portée moyenne, Jumelé 1)
- Blindage 4 : armes lourdes nécessaires.

**Droideka (Destroyer)** — *Némésis*
- Silhouette 2 | Blessure : 14 | Stress : 8 | Blindage : 2
- Combat à distance (armes lourdes) 3 | Double canon blaster (dégâts 10, portée moyenne, Jumelé 1, Cadence de tir 2)
- Bouclier déflecteur : Défense 3 déployé. Déploiement = 1 round.
- *⚠️ Ne PAS utiliser contre les joueurs avant l'Acte 2-3. TPK garanti contre des PJ débutants. Spectacle narratif d'abord.*

**Droïde Custom "Bricolé"** — *Rival (variable)*
- Stats variables. Chaque Bricolé est unique. Le MJ compose sa fiche. Imprévisible : 1 dysfonctionnement créatif par combat.

**Char AAT** — *Véhicule*
- Silhouette 4 | Blindage pare-balles : 3 | Blindage : 4 | Vitesse : 1 | Maniabilité : -2
- Canon laser lourd (dégâts 8, portée longue, Brèche 1) + 2 canons anti-personnel (dégâts 5, portée courte)
- Défauts : Visée qui dérive, moteur qui cale.

#### Les Chromés (droïdes des syndicats)

**B1 Sentinelle** — *Sbire (groupes de 3-4)*
- Blessure : 4 | Blindage : 3 | Blaster modifié (dégâts 9). Tire à vue, pas de sommation.

**B2 "Gros Bras"** — *Rival*
- Stats B2 standard + programme Garde du Corps (prend un coup pour son protégé 1×/round).

**Droïde Assassin Custom** — *Rival (rare)*
- Blessure : 12 | Blindage : 2 | Furtivité 3 | Combat à distance 3 | Bagarre 2
- Fusil avec silencieux + lame vibro intégrée. +2 Revers sur Perception pour le détecter.
...
| **Tova Wget** | Koorivar | Arrakha (Puits Rouges) | Cheffe d'équipe, voix civile indépendante | *wget* |
| **Meema Kern** | Humaine | Forscan Prime | Fermière, contact Réseau Racine | *kernel* |
| **Sergent Drenn Rix** | Zabrak | Arrakha | Sergent garnison Protectorat, soldat qui doute | *rix* |
...
*Fin de l'Acte 1 — Transition vers l'Acte 2 : "LE CHOIX"*
